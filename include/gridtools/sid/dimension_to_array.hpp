    ...
    namespace sid {
        namespace dimension_to_array_impl_ {
            ...
            struct init_helper<std::index_sequence<Is...>> {
                ...
                static GT_FUNCTION array<T, sizeof...(Is)> apply(Fun &&fun) {
                    return {fun(Is)...};
                }
            };
            ...
            struct ptr_array {
                ...
                GT_FUNCTION ptr_array &operator=(TupleLike const &t) { // TODO enable only for tuple_like
                ...
                ptr_array &operator*() { return *this; }
            ...
            template <class OrigPtrHolder, class Strides, size_t N>
            struct ptr_holder {
                OrigPtrHolder m_orig_ptr_holder;
                Strides m_strides;

                auto operator()() const {
                    return ptr<std::decay_t<decltype(std::declval<OrigPtrHolder>()())>, Strides, N>{
